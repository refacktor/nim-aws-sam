#
# AWS Lambda Runtime cloned from https://github.com/lambci/awslambda.nim
# Slightly modified.
#
...
let functionName = getEnv("AWS_LAMBDA_FUNCTION_NAME")
let functionVersion = getEnv("AWS_LAMBDA_FUNCTION_VERSION")
let functionMemorySize = parseInt(getEnv("AWS_LAMBDA_FUNCTION_MEMORY_SIZE"))
let logGroupName = getEnv("AWS_LAMBDA_LOG_GROUP_NAME")
let logStreamName = getEnv("AWS_LAMBDA_LOG_STREAM_NAME")
